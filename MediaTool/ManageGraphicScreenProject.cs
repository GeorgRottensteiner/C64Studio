  ...
  public partial class Manager
  {
    ...
    private int HandleGraphicscreenFile( GR.Text.ArgumentParser ArgParser )
    {
      ...
      if ( !ValidateExportType( "graphicscreen file", exportType, 
          new string[] { 
            "MULTICOLORBITMAPSCREENCOLOR", "MULTICOLORBITMAPCOLORSCREEN", 
            "MULTICOLORBITMAPSCREEN", "MULTICOLORBITMAPCOLOR", 
            "MULTICOLORBITMAP", 
            "MULTICOLORSCREEN", "MULTICOLORCOLOR",
            "HIRESBITMAPSCREENCOLOR", "HIRESBITMAPCOLORSCREEN", 
            "HIRESBITMAPSCREEN", "HIRESBITMAPCOLOR", 
            "HIRESCOLORBITMAP", "HIRESCOLORSCREEN",
            "HIRESSCREENBITMAP", "HIRESSCREENCOLOR",
            "HIRESSCREEN", "HIRESCOLOR", "HIRESBITMAP" } ) )
      {
        return 1;
      }
