...
namespace RetroDevStudio.Parser
{
    public class ASMFileParser : ParserBase
    {
        ...
        public static bool IsTape(CompileTargetType Type)
        {
            return (Type == Types.CompileTargetType.T64) || (Type == Types.CompileTargetType.TAP);
        }

        public static bool IsDisk(CompileTargetType Type)
        {
            return (Type == Types.CompileTargetType.D64) || (Type == Types.CompileTargetType.D81);
        }

        public static bool IsCartridge(CompileTargetType Type)
        {
            return (Type == Types.CompileTargetType.CARTRIDGE_MAGICDESK_BIN)
