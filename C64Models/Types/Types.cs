...
namespace C64Studio.Types
{
  ...
  public class Constants
  {
    ...
    public static string FILEFILTER_MEDIA_FILES = "Tape/Disk Files|*.t64;*.prg;*.d64;*.d81|";
  ...
  public class ConstantData
  {
    ...
    static ConstantData()
    {
      ...
      AddC64Key( KeyboardKey.KEY_A, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 129, true, 1, false, (char)0xee81, true, "REVERSE A" ).Replacements.Add( "CTRL-A" );
      AddC64Key( KeyboardKey.KEY_B, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 130, true, 2, false, (char)0xee82, true, "REVERSE B" ).Replacements.Add( "CTRL-B" );

      AddC64Key( KeyboardKey.KEY_RUN_STOP, KeyModifier.NORMAL, KeyType.CONTROL_CODE, 128 + 3, true, 3, true, (char)0xee83, true, "RUN STOP" ).Replacements.Add( "CTRL-C" ); ;   // run stop
      ...
      AddC64Key( KeyboardKey.KEY_2, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 128 + 5, true, 5, true, (char)0xee85, true, "WHITE", "WHI" ).Replacements.Add( "WHITE" );
      ...
      AddC64Key( KeyboardKey.KEY_RETURN, KeyModifier.NORMAL, KeyType.CONTROL_CODE, 128 + 13, true, 13, true, (char)0xee8d, false, "RETURN", "RET" ).Replacements.Add( "CTRL-M" );  // return
      AddC64Key( KeyboardKey.UNDEFINED, KeyModifier.NORMAL, KeyType.CONTROL_CODE, 128 + 14, true, 14, true, (char)0xee8e, true, "SHIFT C=", "SH C=" ).Replacements.Add( "CTRL-N" );  // toggle upper/lower
      ...
      AddC64Key( KeyboardKey.KEY_9, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 128 + 18, true, 18, true, (char)0xee92, true, "REVERSE ON", "RVS ON" ).Replacements.Add( "RVSON" );
      AddC64Key( KeyboardKey.KEY_CLR_HOME, KeyModifier.NORMAL, KeyType.CONTROL_CODE, 128 + 19, true, 19, true, (char)0xee93, true, "HOME", "HOM" ).Replacements.Add( "HOME" );
      ...
      AddC64Key( KeyboardKey.KEY_U, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 149, true, 21, false, (char)0xee95, true, "REVERSE U" ).Replacements.Add( "CTRL-U" );
      AddC64Key( KeyboardKey.KEY_V, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 150, true, 22, false, (char)0xee96, true, "REVERSE V" ).Replacements.Add( "CTRL-V" );
      AddC64Key( KeyboardKey.KEY_W, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 151, true, 23, false, (char)0xee97, true, "REVERSE W" ).Replacements.Add( "CTRL-W" );
      AddC64Key( KeyboardKey.KEY_X, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 152, true, 24, false, (char)0xee98, true, "REVERSE X" ).Replacements.Add( "CTRL-X" );
      AddC64Key( KeyboardKey.KEY_Y, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 153, true, 25, false, (char)0xee99, true, "REVERSE Y" ).Replacements.Add( "CTRL-Y" );
      AddC64Key( KeyboardKey.KEY_Z, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 154, true, 26, false, (char)0xee9a, true, "REVERSE Z" ).Replacements.Add( "CTRL-Z" );
      AddC64Key( KeyboardKey.KEY_COLON, KeyModifier.SHIFT, KeyType.NORMAL, 155, true, 27, false, (char)0xee9b, true, "[" );
      ...
      AddC64Key( KeyboardKey.KEY_CURSOR_LEFT_RIGHT, KeyModifier.NORMAL, KeyType.CONTROL_CODE, 128 + 29, true, 29, true, (char)0xee9d, true, "CURSOR RIGHT", "CUR RIGHT" ).Replacements.Add( "RIGHT" );
      AddC64Key( KeyboardKey.KEY_6, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 128 + 30, true, 30, true, (char)0xee9e, true, "GREEN", "GRN" ).Replacements.Add( "GREEN" );
      AddC64Key( KeyboardKey.KEY_7, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 128 + 31, true, 31, true, (char)0xee9f, true, "BLUE", "BLU" ).Replacements.Add( "BLUE" );
      //  32- 63 $20-$3F       0 $00         32- 63 $20-$3F  
      ...
      AddC64Key( KeyboardKey.KEY_A, KeyModifier.NORMAL, KeyType.NORMAL, 65 - 64, true, 65, true, 'A', true );
      AddC64Key( KeyboardKey.KEY_B, KeyModifier.NORMAL, KeyType.NORMAL, 66 - 64, true, 66, true, 'B', true );
      AddC64Key( KeyboardKey.KEY_C, KeyModifier.NORMAL, KeyType.NORMAL, 67 - 64, true, 67, true, 'C', true );
      AddC64Key( KeyboardKey.KEY_D, KeyModifier.NORMAL, KeyType.NORMAL, 68 - 64, true, 68, true, 'D', true );
      AddC64Key( KeyboardKey.KEY_E, KeyModifier.NORMAL, KeyType.NORMAL, 69 - 64, true, 69, true, 'E', true );
      AddC64Key( KeyboardKey.KEY_F, KeyModifier.NORMAL, KeyType.NORMAL, 70 - 64, true, 70, true, 'F', true );
      AddC64Key( KeyboardKey.KEY_G, KeyModifier.NORMAL, KeyType.NORMAL, 71 - 64, true, 71, true, 'G', true );
      AddC64Key( KeyboardKey.KEY_H, KeyModifier.NORMAL, KeyType.NORMAL, 72 - 64, true, 72, true, 'H', true );
      AddC64Key( KeyboardKey.KEY_I, KeyModifier.NORMAL, KeyType.NORMAL, 73 - 64, true, 73, true, 'I', true );
      AddC64Key( KeyboardKey.KEY_J, KeyModifier.NORMAL, KeyType.NORMAL, 74 - 64, true, 74, true, 'J', true );
      AddC64Key( KeyboardKey.KEY_K, KeyModifier.NORMAL, KeyType.NORMAL, 75 - 64, true, 75, true, 'K', true );
      AddC64Key( KeyboardKey.KEY_L, KeyModifier.NORMAL, KeyType.NORMAL, 76 - 64, true, 76, true, 'L', true );
      AddC64Key( KeyboardKey.KEY_M, KeyModifier.NORMAL, KeyType.NORMAL, 77 - 64, true, 77, true, 'M', true );
      AddC64Key( KeyboardKey.KEY_N, KeyModifier.NORMAL, KeyType.NORMAL, 78 - 64, true, 78, true, 'N', true );
      AddC64Key( KeyboardKey.KEY_O, KeyModifier.NORMAL, KeyType.NORMAL, 79 - 64, true, 79, true, 'O', true );
      AddC64Key( KeyboardKey.KEY_P, KeyModifier.NORMAL, KeyType.NORMAL, 80 - 64, true, 80, true, 'P', true );
      AddC64Key( KeyboardKey.KEY_Q, KeyModifier.NORMAL, KeyType.NORMAL, 81 - 64, true, 81, true, 'Q', true );
      AddC64Key( KeyboardKey.KEY_R, KeyModifier.NORMAL, KeyType.NORMAL, 82 - 64, true, 82, true, 'R', true );
      AddC64Key( KeyboardKey.KEY_S, KeyModifier.NORMAL, KeyType.NORMAL, 83 - 64, true, 83, true, 'S', true );
      AddC64Key( KeyboardKey.KEY_T, KeyModifier.NORMAL, KeyType.NORMAL, 84 - 64, true, 84, true, 'T', true );
      AddC64Key( KeyboardKey.KEY_U, KeyModifier.NORMAL, KeyType.NORMAL, 85 - 64, true, 85, true, 'U', true );
      AddC64Key( KeyboardKey.KEY_V, KeyModifier.NORMAL, KeyType.NORMAL, 86 - 64, true, 86, true, 'V', true );
      AddC64Key( KeyboardKey.KEY_W, KeyModifier.NORMAL, KeyType.NORMAL, 87 - 64, true, 87, true, 'W', true );
      AddC64Key( KeyboardKey.KEY_X, KeyModifier.NORMAL, KeyType.NORMAL, 88 - 64, true, 88, true, 'X', true );
      AddC64Key( KeyboardKey.KEY_Y, KeyModifier.NORMAL, KeyType.NORMAL, 89 - 64, true, 89, true, 'Y', true );
      AddC64Key( KeyboardKey.KEY_Z, KeyModifier.NORMAL, KeyType.NORMAL, 90 - 64, true, 90, true, 'Z', true );
      ...
      // 128-159 $80-$9F     +64 $40        192-223 $C0-$DF  
      AddC64Key( KeyboardKey.KEY_AT, KeyModifier.SHIFT, KeyType.CONTROL_CODE, 192, true, 0, false, (char)0xeec0, true, "REVERSE SHIFT @" );

      AddC64Key( KeyboardKey.KEY_1, KeyModifier.COMMODORE, KeyType.CONTROL_CODE, 129 + 64, true, 129, true, (char)0xeec1, true, "ORANGE", "ORN" ).Replacements.Add( "ORANGE" );   // orange

      AddC64Key( KeyboardKey.KEY_B, KeyModifier.SHIFT, KeyType.CONTROL_CODE, 194, true, 0, false, (char)0xeec2, true, "REVERSE SHIFT B" );
      ...
      AddC64Key( KeyboardKey.KEY_F7, KeyModifier.SHIFT, KeyType.CONTROL_CODE, 140 + 64, true, 140, true, (char)0xeecc, true, "F8" ).Replacements.Add( "F6" );   // TODO F8
      AddC64Key( KeyboardKey.KEY_RETURN, KeyModifier.SHIFT, KeyType.CONTROL_CODE, 141 + 64, true, 141, true, (char)0xeecd, true, "SHIFT RETURN", "SH RET" ).Replacements.Add( "SHIFT-RETURN" );   // TODO Shift-Return
      AddC64Key( KeyboardKey.KEY_N, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 142 + 64, true, 142, true, (char)0xeece, true, "UPPERCASE", "UPCASE" ).Replacements.Add( "CTRL-N" );   // TODO Uppercase

      AddC64Key( KeyboardKey.KEY_O, KeyModifier.SHIFT, KeyType.CONTROL_CODE, 207, true, 0, false, (char)0xeecf, true, "REVERSE SHIFT O" );

      AddC64Key( KeyboardKey.KEY_1, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 144 + 64, true, 144, true, (char)0xeed0, true, "BLACK", "BLK" ).Replacements.Add( "BLACK" );   // black
      ...
      AddC64Key( KeyboardKey.KEY_0, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 146 + 64, true, 146, true, (char)0xeed2, true, "REVERSE OFF", "RVS OFF" ).Replacements.Add( "RVSOFF" );   // TODO rvs off
      ...
      AddC64Key( KeyboardKey.KEY_2, KeyModifier.COMMODORE, KeyType.CONTROL_CODE, 149 + 64, true, 149, true, (char)0xeed5, true, "BROWN", "BRN" ).Replacements.Add( "BROWN" );   // brown
      AddC64Key( KeyboardKey.KEY_3, KeyModifier.COMMODORE, KeyType.CONTROL_CODE, 150 + 64, true, 150, true, (char)0xeed6, true, "LIGHT RED", "LRD" ).Replacements.AddRange( new string[] { "LIGHT RED", "PINK" } );   // light red
      AddC64Key( KeyboardKey.KEY_4, KeyModifier.COMMODORE, KeyType.CONTROL_CODE, 151 + 64, true, 151, true, (char)0xeed7, true, "GREY 1", "GR1" ).Replacements.AddRange( new string[]{ "GREY 1", "GRAY 1", "DARK GRAY", "DARK GREY" } );      // grey 1
      AddC64Key( KeyboardKey.KEY_5, KeyModifier.COMMODORE, KeyType.CONTROL_CODE, 152 + 64, true, 152, true, (char)0xeed8, true, "GREY 2", "GR2" ).Replacements.AddRange( new string[]{ "GREY 2", "GRAY 2" } );      // grey 2
      AddC64Key( KeyboardKey.KEY_6, KeyModifier.COMMODORE, KeyType.CONTROL_CODE, 153 + 64, true, 153, true, (char)0xeed9, true, "LIGHT GREEN", "LGR" ).Replacements.Add( "LIGHT GREEN" ); // light green
      AddC64Key( KeyboardKey.KEY_7, KeyModifier.COMMODORE, KeyType.CONTROL_CODE, 154 + 64, true, 154, true, (char)0xeeda, true, "LIGHT BLUE", "LBL" ).Replacements.Add( "LIGHT BLUE" );  // light blue
      AddC64Key( KeyboardKey.KEY_8, KeyModifier.COMMODORE, KeyType.CONTROL_CODE, 155 + 64, true, 155, true, (char)0xeedb, true, "GREY 3", "GR3" ).Replacements.AddRange( new string[] { "GREY 3", "GRAY 3", "LIGHT GREY", "LIGHT GRAY" } );      // grey 3
      AddC64Key( KeyboardKey.KEY_5, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 156 + 64, true, 156, true, (char)0xeedc, true, "PURPLE", "PUR" ).Replacements.Add( "PURPLE" );      // purple
      AddC64Key( KeyboardKey.KEY_CURSOR_LEFT_RIGHT, KeyModifier.SHIFT, KeyType.CONTROL_CODE, 157 + 64, true, 157, true, (char)0xeedd, true, "CURSOR LEFT", "CUR LEFT" ).Replacements.Add( "LEFT" );   // TODO cursor left
      AddC64Key( KeyboardKey.KEY_8, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 158 + 64, true, 158, true, (char)0xeede, true, "YELLOW", "YEL" ).Replacements.Add( "YELLOW" );    // yellow
      AddC64Key( KeyboardKey.KEY_4, KeyModifier.CONTROL, KeyType.CONTROL_CODE, 159 + 64, true, 159, true, (char)0xeedf, true, "CYAN", "CYN" ).Replacements.Add( "CYAN" );      // TODO cyan

      // 160-191 $A0-$BF     -64 $C0         96-127 $60-$7F  
      AddC64Key( KeyboardKey.KEY_SPACE, KeyModifier.SHIFT, KeyType.GRAPHIC_SYMBOL, 160 - 64, true, 160, true, (char)0xee60, true, "SHIFT SPACE" ).Replacements.Add( "SHIFT SPACE" );   // shift-space
    ...
    {
      return AddC64Key( Key, Modifier, Type, ScreenCodeValue, HasScreenCode, PetSCIIValue, HasPetSCII, CharValue, HasChar, "" + CharValue, "" );
    }
    ...
    {
      return AddC64Key( Key, Modifier, Type, ScreenCodeValue, HasScreenCode, PetSCIIValue, HasPetSCII, CharValue, HasChar, Desc, "" );
    }



    static C64Character AddC64Key( KeyboardKey Key, KeyModifier Modifier, KeyType Type, byte ScreenCodeValue, bool HasScreenCode, byte PetSCIIValue, bool HasPetSCII, char CharValue, bool HasChar, string Desc, string ShortDesc )
    {
