...
namespace C64Studio
{
  ...
  public class StudioSettings
  {
    ...
    public bool                                 BASICUseNonC64Font = true;
    ...
    public GR.Collections.Map<Types.SyntaxElement,Types.SyntaxColor>    SyntaxColoring = new GR.Collections.Map<C64Studio.Types.SyntaxElement, C64Studio.Types.SyntaxColor>();
    ...
    public GR.Collections.Map<string, ToolWindow> Tools = new GR.Collections.Map<string, ToolWindow>();
    ...
    private IDockContent GetContentFromPersistString( string persistString )
    {
      ...
      {
        if ( persistString == toolEntry.Key )
        {
    ...
    public void SetSyntaxColor( C64Studio.Types.SyntaxElement Element, uint FGColor, uint BGColor, bool AutoBGColor )
    {
      if ( SyntaxColoring[Element] == null )
      {
        SyntaxColoring[Element] = new C64Studio.Types.SyntaxColor( GR.EnumHelper.GetDescription( Element ), FGColor, BGColor );
      }
      else
      {
    ...
    {
      SetSyntaxColor( C64Studio.Types.SyntaxElement.NONE, 0xff800000, 0xffffffff, true );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.CODE, 0x00000000, 0xffffffff, true );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.LITERAL_STRING, 0xff008000, 0xffffffff, true );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.LITERAL_NUMBER, 0xff0000ff, 0xffffffff, true );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.LABEL, 0xff800000, 0xffffffff, true );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.COMMENT, 0xff008000, 0xffffffff, true );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.PSEUDO_OP, 0xffff8000, 0xffffffff, true );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.CURRENT_DEBUG_LINE, 0xff000000, 0xffffff00, false );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.EMPTY_SPACE, 0xff000000, 0xffffffff, false );
      SetSyntaxColor( C64Studio.Types.SyntaxElement.OPERATOR, 0xff000080, 0xffffffff, true );
    }
