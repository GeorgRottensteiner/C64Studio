...
{
  public partial class ColorSettingsMCCharacterTED : ColorSettingsBase
  {
    ...
    public ColorSettingsMCCharacterTED() :
      base( null, null, 0 )
    { 
    }
    ...
    public ColorSettingsMCCharacterTED( StudioCore Core, ColorSettings Colors, byte CustomColor ) :
