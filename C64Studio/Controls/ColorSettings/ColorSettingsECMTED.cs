...
{
  public partial class ColorSettingsECMTED : ColorSettingsBase
  {
    ...
    public ColorSettingsECMTED( StudioCore Core, ColorSettings Colors, byte CustomColor ) :
      base( Core, Colors, CustomColor )
    {
      ...
      comboBGColor4.SelectedIndex     = Colors.BGColor4 % comboBGColor4.Items.Count;
