...
namespace DecentForms
{
  ...
  public class ListControlSubItemCollection : IEnumerable<ListControlSubItem>
  {
    private ListControl               _Owner;
    private List<ListControlSubItem>  _Items = new List<ListControlSubItem>();



    internal ListControlSubItemCollection( ListControl Owner )
    {
      _Owner = Owner;
    }
    ...
    public int IndexOf( ListControlSubItem Item )
    {
    ...
    public int Add( ListControlSubItem Item )
    {
      _Items.Add( Item );
      Item._Owner = _Owner;
    ...
    {
      return Add( new ListControlSubItem( Text ) );
    }
    ...
    public void AddRange( string[] Items )
    {
      ...
      {
        var newItem = new ListControlSubItem( item );
    ...
    public bool Remove( ListControlSubItem Item )
    {
      if ( Item.Index == -1 )
      {
        return false;
    ...
    public ListControlSubItem this[int Index]
    {
      get
      {
        if ( ( Index < 0 )
    ...
    public IEnumerator<ListControlSubItem> GetEnumerator()
    {
    ...
    public void Insert( int InsertAtIndex, ListControlSubItem Item )
    {
      if ( ( InsertAtIndex < 0 )
