...
{
  partial class ExportCharsetAsAssembly
  {
    /// <summary> 
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "ExportCharsetAsAssembly";
