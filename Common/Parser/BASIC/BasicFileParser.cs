...
namespace RetroDevStudio.Parser.BASIC
{
  public partial class BasicFileParser : ParserBase
  {
    ...
    public LineInfo PureTokenizeLine( string Line )
    {
    ...
    public bool IsDataToken( Token token )
    {
    ...
    public LineInfo TokenizeLine( string Line, int LineIndex, ref int LastLineNumber )
    {
      if ( Line.Length == 0 )
      {
    ...
    public static bool IsValidChar( bool UpperCaseMode, char Character )
    {
      if ( !UpperCaseMode )
      {
        // lower case mode
