...
namespace RetroDevStudio.Types
{
  public class ColorSettings
  {
    ...
    private List<GR.Image.Palette>  _palettes = new List<GR.Image.Palette>();
    ...
    public List<GR.Image.Palette> Palettes
    {
      get
      {
        return _palettes;
    ...
    {
      Palettes.Add( new GR.Image.Palette() );
    ...
    public ColorSettings( ColorSettings OtherSettings )
    {
      ...
      Palettes = new List<GR.Image.Palette>();
      foreach ( var pal in OtherSettings.Palettes )
      {
        Palettes.Add( new GR.Image.Palette( pal ) );
      }
