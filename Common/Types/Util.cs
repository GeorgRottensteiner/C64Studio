...
namespace RetroDevStudio
{
  public partial class Util
  {
    ...
    public static string ToBASICData( GR.Memory.ByteBuffer Data, int StartLine, int LineOffset, int WrapByteCount, int WrapCharCount, bool InsertSpaces, bool AsHex, int padCount )
    {
      if ( AsHex )
      {
    ...
    public static string ToBASICData( GR.Memory.ByteBuffer Data, int StartLine, int LineOffset, int WrapByteCount, int WrapCharCount, bool InsertSpaces, int padCount )
    {
      StringBuilder   sb = new StringBuilder();
    ...
    public static string ToBASICHexData( GR.Memory.ByteBuffer Data, int StartLine, int LineOffset, bool InsertSpaces, int padCount )
    {
      StringBuilder   sb = new StringBuilder();
    ...
    public static string ToBASICHexData( GR.Memory.ByteBuffer Data, int StartLine, int LineOffset, int WrapByteCount, int WrapCharCount, bool InsertSpaces, int padCount )
    {
      if ( ( WrapByteCount < 1 )
      &&   ( WrapCharCount < 1 ) )
      {
    ...
    public static ByteBuffer FromBASIC( string Text )
    {
    ...
    public static ByteBuffer FromBASICHex( string Text )
    {
      string[]  lines = Text.Split( new char[] { '\n' } );
    ...
    public static ByteBuffer FromASMData( string Text )
    {
