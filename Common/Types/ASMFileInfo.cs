...
namespace RetroDevStudio.Types.ASM
{
  ...
  public class FileInfo
  {
    ...
    public Dictionary<string, List<Zone>>         Zones = new Dictionary<string, List<Zone>>();
    ...
    public void InsertLines( string modifiedDocument, int GlobalLineIndex, int LocalLineIndex, int LineCount )
    {
    ...
    public void RemoveLines( string modifiedDocument, int GlobalLineIndex, int LocalLineIndex, int LineCount )
    {
      var modifiedSourceInfo = SourceInfo.Values.Where( si => GR.Path.IsPathEqual( si.Filename, modifiedDocument ) ).FirstOrDefault();
