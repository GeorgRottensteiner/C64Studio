...
namespace RetroDevStudio
{
  ...
  {
    public static Dictionary<CompileTargetType,string>  CompileTargetModeToKeyword = new Dictionary<CompileTargetType, string>();

    public static Dictionary<MediaFormatType,GR.Generic.Tupel<Type,string>>         MediaFormatToTypeAndExtension = new Dictionary<MediaFormatType, GR.Generic.Tupel<Type, string>>();
    public static Dictionary<MediaFormatType,GR.Generic.Tupel<MediaType, string>>   MediaFormatCategories = new Dictionary<MediaFormatType, GR.Generic.Tupel<MediaType, string>>();
    ...
    public static int NumBytesForGraphic( int Width, int Height, GraphicTileMode Mode )
    {
      switch ( Mode )
      {
    ...
    public static int NumCharactersForMode( TextCharMode Mode )
    {
      switch ( Mode )
      {
        case TextCharMode.COMMODORE_ECM:
    ...
    public static bool TextModeUsesColor( TextMode Mode )
    {
      switch ( Mode )
      {
        case TextMode.MEGA65_40_X_25_FCM:
    ...
    public static bool HasCustomPalette( GraphicTileMode Mode )
    {
      switch ( Mode )
      {
        case GraphicTileMode.COMMODORE_ECM:
    ...
    public static bool AllowPaletteModification( PaletteType PalType )
    {
      switch ( PalType )
      {
    ...
    public static bool HasCustomPalette( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
    ...
    public static int NumBytesOfSingleSprite( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        case SpriteProject.SpriteProjectMode.COMMODORE_24_X_21_HIRES_OR_MC:
    ...
    public static int NumPaddedBytesOfSingleSprite( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        case SpriteProject.SpriteProjectMode.COMMODORE_24_X_21_HIRES_OR_MC:
    ...
    public static int NumberOfColorsInSprite( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        case SpriteProject.SpriteProjectMode.COMMODORE_24_X_21_HIRES_OR_MC:
    ...
    public static GraphicTileMode GraphicTileModeFromTextCharMode( TextCharMode Mode, int CustomColor )
    {
      switch ( Mode )
      {
        case TextCharMode.COMMODORE_ECM:
        ...
        case TextCharMode.VIC20_8X16:
          if ( CustomColor < 8 )
          {
            return GraphicTileMode.COMMODORE_HIRES_8X16;
          }
          return GraphicTileMode.COMMODORE_MULTICOLOR_CHARACTERS_8X16;
        case TextCharMode.MEGA65_NCM:
    ...
    public static GraphicTileMode GraphicTileModeFromSpriteDisplayMode( SpriteDisplayMode Mode )
    {
      switch ( Mode )
      {
    ...
    public static GraphicTileMode GraphicTileModeFromSpriteProjectMode( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        case SpriteProject.SpriteProjectMode.COMMODORE_24_X_21_HIRES_OR_MC:
    ...
    public static bool HaveCustomSpriteColor( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        /*
    ...
    public static SpriteMode SpriteModeFromSpriteProjectMode( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        default:
    ...
    public static bool SpriteModeSupportsMulticolorFlag( SpriteProject.SpriteProjectMode Mode )
    {
    ...
    public static bool SpriteModeHasMulticolorEnabled( SpriteMode Mode )
    {
    ...
    public static int CharacterWidthInPixel( GraphicTileMode Mode )
    {
      switch ( Mode )
      {
        case GraphicTileMode.MEGA65_NCM_CHARACTERS:
    ...
    public static int CharacterHeightInPixel( GraphicTileMode Mode )
    {
      switch ( Mode )
      {
        case GraphicTileMode.MEGA65_NCM_CHARACTERS:
    ...
    public static int PixelWidth( GraphicTileMode Mode )
    {
      switch ( Mode )
      {
        case GraphicTileMode.COMMODORE_MULTICOLOR_CHARACTERS:
    ...
    public static TextMode TextModeFromTextCharMode( TextCharMode Mode )
    {
      switch ( Mode )
      {
        case TextCharMode.MEGA65_ECM:
        ...
        case TextCharMode.VIC20:
          return TextMode.COMMODORE_VIC20_8_X_8;
        default:
    ...
    public static int ScreenWidthInCharacters( TextMode Mode )
    {
      switch ( Mode )
      {
        case TextMode.COMMODORE_40_X_25_ECM:
    ...
    public static int ScreenHeightInCharacters( TextMode Mode )
    {
      switch ( Mode )
      {
        case TextMode.COMMODORE_40_X_25_ECM:
    ...
    public static SpriteMode SpriteModeFromTileMode( GraphicTileMode Mode )
    {
      switch ( Mode )
      {
        case GraphicTileMode.COMMODORE_ECM:
    ...
    public static GraphicTileMode GraphicTileModeFromSpriteMode( SpriteMode Mode )
    {
      switch ( Mode )
      {
    ...
    public static MachineType MachineTypeFromTextMode( TextMode Mode )
    {
      switch ( Mode )
      {
        case TextMode.X16_20_X_15:
    ...
    public static bool TextModeInterleavesCharAndColor( TextMode Mode )
    {
      switch ( Mode )
      {
        case TextMode.X16_20_X_15:
    ...
    public static int SpriteWidth( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        case SpriteProject.SpriteProjectMode.COMMODORE_24_X_21_HIRES_OR_MC:
    ...
    public static int SpriteHeight( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        case SpriteProject.SpriteProjectMode.COMMODORE_24_X_21_HIRES_OR_MC:
    ...
    public static GraphicType GraphicImportTypeFromMode( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        case SpriteProject.SpriteProjectMode.COMMANDER_X16_8_8_16_COLORS:
    ...
    public static PaletteType PaletteTypeFromTextCharMode( TextCharMode Mode )
    {
      switch ( Mode )
      {
        case TextCharMode.X16_HIRES:
    ...
    public static PaletteType PaletteTypeFromSpriteMode( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
        case SpriteProject.SpriteProjectMode.COMMODORE_24_X_21_HIRES_OR_MC:
    ...
    public static MediaFormatType MediaFormatFromExtension( string extension )
    {
    ...
    public static MachineType MachineFromMediaFormatType( MediaFormatType mediaFormatType )
    {
    ...
    public static bool IsECMMode( TextCharMode mode )
    {
      switch ( mode )
      {
        case TextCharMode.COMMODORE_ECM:
