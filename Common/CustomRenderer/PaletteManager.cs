...
namespace RetroDevStudio
{
  ...
  {
    public static GR.Image.Palette PaletteFromType( PaletteType Type )
    {
      switch ( Type )
      {
    ...
    public static GR.Image.Palette PaletteFromMode( TextCharMode Mode )
    {
      switch ( Mode )
      {
    ...
    public static void ApplyPalette( GR.Image.IImage Image, GR.Image.Palette Palette )
    {
    ...
    public static GR.Image.Palette PaletteFromMode( SpriteProject.SpriteProjectMode Mode )
    {
      switch ( Mode )
      {
