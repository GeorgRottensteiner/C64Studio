...
namespace FastColoredTextBoxNS
{
  public class CommandManager
  {
    ...
    public virtual void ExecuteCommand( Command cmd )
    {
      ...
      {
        TextSource.CurrentTB.OnUndoRedoStateChanged( UndoRedoEventArgs.UndoRedoAction.UNDO_ADDED, false );
      }
    }
    ...
    public void Undo()
    {
      if ( history.Count > 0 )
      {
        ...
        //
        redoStack.Push( cmd );
        TextSource.CurrentTB.OnUndoRedoStateChanged( UndoRedoEventArgs.UndoRedoAction.UNDO_HANDLED );
      }
    ...
    public void EndAutoUndoCommands()
    {
      ...
      TextSource.CurrentTB.OnUndoRedoStateChanged( UndoRedoEventArgs.UndoRedoAction.UNDO_ADDED, wasGrouped );
    }
    ...
    internal void ClearHistory()
    {
      history.Clear();
      redoStack.Clear();
      TextSource.CurrentTB.OnUndoRedoStateChanged( UndoRedoEventArgs.UndoRedoAction.UNDO_REDO_CLEARED );
    }
    ...
    internal void Redo()
    {
      ...
      try
      {
        ...
        cmd.Execute();
        history.Push( cmd );
        TextSource.CurrentTB.OnUndoRedoStateChanged( UndoRedoEventArgs.UndoRedoAction.REDO_HANDLED );
      }
      finally
      {
        EndDisableCommands();
