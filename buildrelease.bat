...
if exist C64Ass-Linux.tar.gz del C64Ass-Linux.tar.gz
...
cd ..\..\..
cd "C64StudioRelease\net10.0-windows\AnyCPU"
%winrar% -ibck a -r -afzip ..\..\..\C64StudioRelease10.0.zip -apC64StudioRelease\net10.0-windows .
cd ..\..\..
...
%winrar% -ibck a -afzip -r -ep1 -apC64StudioRelease\net10.0-windows ..\..\C64StudioRelease.zip "*.*" 

%winrar% -ibck a -afzip -r -ep1 -apC64StudioRelease\net3.5 ..\..\C64StudioRelease3.5.zip "*.*" 
%winrar% -ibck a -afzip -r -ep1 -apC64StudioRelease\net4.8 ..\..\C64StudioRelease4.8.zip "*.*" 
%winrar% -ibck a -afzip -r -ep1 -apC64StudioRelease\net10.0-windows ..\..\C64StudioRelease10.0.zip "*.*" 
cd ..\..
